...
public class PlayersClient extends CoreClient {
  ...
  public static void main(String[] args) throws InvalidName, NotFound, CannotProceed,
    ...
    try {
      System.out.println(
          "NOTE -- Player Logs available at " + System.getProperty("user.dir") + "/player_logs/");
      System.out.println("Seeded Accounts -- \"whiteallen7\" , " + "\"billy20\" , \"petula71\" -- "
  ...
  private static void playerTransferAccount() {
    ...
    do {
      System.out.println(
          "NOTE: Ensure that the region of the IP Address to Transfer is different from your current region!");
  ...
  private static void realizePlayerTransferAccount(String uName, String password,
      String oldIpAddress, String newIpAddress) throws InvalidName, NotFound, CannotProceed,
      org.omg.CosNaming.NamingContextPackage.InvalidName {
  ...
  private static void realizeCreatePlayerAccount(String fName, String lName, String uName,
      String password, int age, String ipAddress) throws InvalidName, NotFound, CannotProceed,
      org.omg.CosNaming.NamingContextPackage.InvalidName {
    String retStatement =
        serverStub.createPlayerAccount(fName, lName, uName, password, ipAddress, age);
    System.out.println(retStatement);
  ...
  private static void realizePlayerSignOut(String uName, String ipAddress) throws InvalidName,
      NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {

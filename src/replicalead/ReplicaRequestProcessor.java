...
public class ReplicaRequestProcessor {
	...
	protected static void verifyConsistentResults() {
		if(leaderResponse != null && replicaOneResponse != null  && replicaTwoResponse != null)
		{
			...
			{
				handleCompletedResponses(leaderResponseParts, replicaOneResponseParts, replicaTwoResponseParts);
	...
	private static void handleCompletedResponses(String[] leaderResponseParts, String[] replicaOneResponseParts,
			String[] replicaTwoResponseParts) {
